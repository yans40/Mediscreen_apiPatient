...
public class PatientControllerTest {
    ...
    public void testGetPatientById() throws Exception {
        ...
        mockMvc.perform(get("/apipatient/patients/{id}", patientId))
    ...
    public void testUpdatePatient() throws Exception {
        ...
        mockMvc.perform(put("/apipatient/patients/{id}", existingPatient.getId())
                        .content(objectMapper.build().writeValueAsString(existingPatient))
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.dateDeNaissance").value("01/01/1990")) // Utiliser le formatter pour formater la date
